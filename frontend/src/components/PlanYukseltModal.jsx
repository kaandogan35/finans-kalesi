  ...
  return (
    <>
      <style>{`
        ...
        .abn-close-btn:hover { background: rgba(255,255,255,0.12); color: #fff; }
        .abn-toggle-row {
        ...
        .abn-toggle-label.aktif { color: #fff; }
        .abn-toggle-switch {
        ...
        .abn-toggle-switch.on { background: #f59e0b; }
        .abn-toggle-knob {
        ...
        .abn-plan-feature.kisit i { color: rgba(255,255,255,0.2); }
        .abn-plan-feature.kisit { color: rgba(255,255,255,0.3); }
        .abn-btn-abone {
        ...
        .abn-btn-abone.amber:hover { transform: translateY(-1px); box-shadow: 0 6px 18px rgba(245,158,11,0.4); }
        .abn-btn-abone.mavi {
                    ...
                    <div className={`abn-plan-card ${aktif ? 'aktif-plan' : ''} ${plan.onerilen ? 'onerilen' : ''}`}>
                      ...
                      <div className="d-flex align-items-center justify-content-between mb-3" style={{ minHeight: 22 }}>
                        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                          {aktif && (
                            <span className="abn-plan-badge" style={{ background: 'rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.6)' }}>
                              Aktif Plan
                            </span>
                          )}
                          {plan.onerilen && !aktif && (
                            <span className="abn-plan-badge" style={{ background: 'rgba(245,158,11,0.15)', color: '#f59e0b' }}>
                              Önerilen
                            </span>
                          )}
                        </div>
                      ...
                      <div className="d-flex align-items-center gap-2 mb-3">
                        ...
                        <span style={{ fontSize: 15, fontWeight: 800, color: '#fff' }}>{plan.ad}</span>
                      </div>
                      ...
                      <div className="mb-1">
                        {plan.id === 'ucretsiz' ? (
                          ...
                          <>
                            {plan.kampanya && !yillik && (
                              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', textDecoration: 'line-through', fontFamily: 'Inter' }}>
                                {fmt(FIYATLAR.standart.aylik)}₺/ay
                              </div>
                            )}
                            <div className="d-flex align-items-baseline gap-1">
                              <span className="abn-plan-price-val">{fmt(plan.fiyat)}</span>
                              <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)', fontWeight: 600 }}>₺{plan.birim}</span>
                            </div>
                            {yillik && (
